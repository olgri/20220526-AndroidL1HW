class State(nameOfState: String = "Belarus", capitalOfState: City){
    val capital = capitalOfState
    val name = nameOfState
    var regions: List<Region> = emptyList<Region>()
    fun addRegion(region: Region) {regions+=region}
    fun printCapital() {
...
class Region(nameOfRegion: String, capitalOfRegion: City, squareOfRegion: Int) {
    val  capital = capitalOfRegion
    val name = nameOfRegion
    val square = squareOfRegion
    var districts: List<District> = emptyList<District>()
    fun addDistrict(district: District) {districts+=district}
    fun printCapital() {
        println(capital.name)}
}
class District(nameOfDistrict: String) {
    val name = nameOfDistrict
    var cities: List<City> = emptyList<City>()
    fun addCity(city: City) {cities+=city}
}
class City (nameOfCity: String) {
 val name = nameOfCity
}
